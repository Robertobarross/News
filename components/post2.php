...
mysqli_query($link, "INSERT INTO tb_post2(tema,imagem,titulo,relevantes,noticia,dt,hr,usuario)VALUES('$tema','$imagem','$titulo','$relevantes','$noticia','$dt','$hr','$usuario')");

header('location:/projetos-php/news/pages/form-post2.php');
